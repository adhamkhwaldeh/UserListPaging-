...
import 'package:common_library/themes/theme_helper.dart';
...
class DarkTheme {
  ...
  // Color(0xFF283350); //
  static const Color _captionColor = Color(0xFFF7F8FC);
  ...
  static final InputDecorationTheme _inputDecorationTheme =
    ...
    labelStyle: _textTheme.subtitle1?.copyWith(
      color: _textColor,
      fontWeight: FontWeight.w500,
      //  color: _whiteColor,
    ),
  ...
  static final AppBarTheme _appBarTheme = AppBarTheme(
    ...
    toolbarTextStyle: _textTheme.subtitle1?.copyWith(
      color: _textColor,
    ),
  );

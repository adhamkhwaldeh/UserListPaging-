...
class _ApiService implements ApiService {
  ...
  @override
  Future<SignInResponse> auth(SignInModel signInModel) async {
  ...
  @override
  Future<SignInResponse> refresh(RefreshModel refreshModel) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<UserListResponse> getUsers({
    required int page,
    int limit = ApiConfiguration.pagingSize,
  }) async {
    final _extra = <String, dynamic>{};

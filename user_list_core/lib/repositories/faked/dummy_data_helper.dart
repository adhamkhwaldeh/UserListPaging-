...
class DummyDataHelper {
  ...
  static List<User> userList = [
    ...
    User(id: "3", name: "Joury", status: Status.active, gender: Gender.female),
    User(id: "4", name: "Jawad", status: Status.active, gender: Gender.male),
    User(id: "5", name: "Wateen", status: Status.active, gender: Gender.female),
    ...
    User(id: "8", name: "Hayat", status: Status.active, gender: Gender.female),
    User(id: "8", name: "Reham", status: Status.active, gender: Gender.female),
  ];
}
